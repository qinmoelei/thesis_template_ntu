...
A thread common to all three gaps is the placement of the aggregation mechanism. EarnHFT learns it, FineFT derives it heuristically from generative distributional-familiarity scores, and AlphaQD removes it from the reward entirely---a progression that the remainder of the thesis develops.
